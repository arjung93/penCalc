...
\usepackage[style=authoryear, bibencoding=utf8,  natbib=true,
backend=biber]{biblatex}  
\addbibresource{pencalc.bib}
...
Rs.25,000 p.m, and is expected to grow at 5\% each year. The
...
described in Section \ref{ss:macro} (7\% for government bonds, 10\%
...
y <- pencalc(inv.weights=list(weightmatrix),
             annuity=list(perc.annuitised=1,
             type="price",   
             value=4087,
             service.tax= 0.00))
y
